...
PlaybackPane::PlaybackPane(AudioFormatManager& audio_format_manager,
    ...
    load_different_button.addListener(this);
    follow_playback_button.addListener(this);
    bypass_button.addListener(this);
    scroll_bar.addListener(this);
...
PlaybackPane::~PlaybackPane() noexcept {
    ...
    load_different_button.removeListener(this);
    follow_playback_button.removeListener(this);
    bypass_button.removeListener(this);
    scroll_bar.removeListener(this);
}
